...
- **Read-only:** the statement tried to write. Rephrase as a read, or the operator must grant the write in the policy profile. `my_permissions` says up front whether writes are available at all.
